/* Inject Cart Drawer HTML automatically */
(function() {
    ...
    <div id="cartDrawer" class="cart-drawer">
        ...
        <div class="cart-content">
            <div class="cart-header">
                <h2>Shopping Cart</h2>
                <button class="icon-btn" id="closeCartBtn">
...
document.addEventListener('DOMContentLoaded', () => {
    const cb = document.getElementById('closeCartBtn');
    if (cb) cb.addEventListener('click', closeCart);
    const cb_btn = document.getElementById('cartBtn');
    if (cb_btn) cb_btn.addEventListener('click', openCart);
});
...
function renderCart() {
    ...
    cartItems.innerHTML = cart.map(item => {
        ...
        const displayImage = item.image || (product ? product.images[0] : '/images/techcity1.jpg');
